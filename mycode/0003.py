...
mnist = input_data.read_data_sets("fashion-mnist_test.csv", one_hot=True)
# 定义网络的超参数
...
vv ,bb =batch_x, batch_y = mnist.train.next_batch(batch_size)
print(len(vv[0]))
print(len(mnist.test.images[0:256]))
# 输入占位符
...
with tf.Session() as sess:
    ...
    saver.save(sess, 'C:\\modle\\model.ckpt')